...
"subquery
select customer_id ,FIRST_name, LAST_name from zvr_customer where customer_id IN ( SELECT customer_id from zvr_Account ) into table @data(wa_subquery2).
out->write( wa_subquery2 ).
endmethod.
