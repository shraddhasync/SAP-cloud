...
"WHERE -single row   (equal = '='  .  unequal = '<>'  ,   in between = 'where birth_date BETWEEN '20034060' AND '20067086'  ,   LIKE = 'where email_id LIKE '%gmail.com'    ,    AND = 'where city = 'jaipur' AND join_Date > '20034647'   ,    IN = 'where city IN ('delhi' , 'mumbai')    /    OR = 'where city = 'delhi' OR city = ' mumbai'    ,     NOT = 'where NOT city = 'delhi' 
